...
class mySQLTelegramDB:
    def __init__(self):
        ...
        self.m_sServerUser = "telegram"
        self.m_sServerPasswd = "MdWbyTiW2TQGNfGx4MdJ"
        self.m_sServerDatabaseUser = "telegram_financial_frauds_parser"
        self.m_sServerDatabasePasswd = "SxhKaUUlYycrjeRipMUa"
        self.m_sServerDatabase = "telegram_financial_frauds"
        self.m_sServerPort = "3306"
        self.telegram_conn = None
        self.telegram_cursor = None
        self.telegram_data_root = "/home/telegram/"
